...
/**
 * This class is the core of quality calculations.
 * It's important to use fields name here in the filters
 */
public class CustomScore {
     ...
     *
     * if original delay is -1 this mean we don't wanna to revisit this url.
     * We assume for each quality criteria there are a score (-1 to 1) otherwise it's zero
     */
    public static int getDelayPeriod(Metadata metadata, HashMap<String, Float> scores, int baseDelayPeriod) {
